...
local stats = {
	...
	--skeletal = { name=S("Skeletal Bones"), material="lib_materials:lead_ingot", armor=1.6, heal=0, use=500, radiation=80*1.1 },
...
for key, tmp_armor in pairs(stats) do
  ...
  gal.player.armor:register_armor("lib_armor:helmet_skeletal", {
  ...
  gal.player.armor:register_armor("lib_armor:chestplate_skeletal", {
  ...
  gal.player.armor:register_armor("lib_armor:leggings_skeletal", {
  ...
  gal.player.armor:register_armor("lib_armor:boots_skeletal", {
  ...
  gal.player.armor:register_armor("lib_armor:shield_skeletal", {
  ...
  gal.player.armor:register_armor("lib_armor:helmet_tacnayn", {
  ...
  gal.player.armor:register_armor("lib_armor:chestplate_tacnayn", {
  ...
  gal.player.armor:register_armor("lib_armor:leggings_tacnayn", {
  ...
  gal.player.armor:register_armor("lib_armor:boots_tacnayn", {
  ...
  gal.player.armor:register_armor("lib_armor:shield_tacnayn", {
