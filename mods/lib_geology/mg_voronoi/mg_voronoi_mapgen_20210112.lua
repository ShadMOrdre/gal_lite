...
--##	(2400 * 0.1) * 0.25 == 240 / 4 == 60
	...
	mg_voronoi.mg_noise_3d_base_spread = 384
...
-- ## VORONOI DISTANCE CALCULATIONS
				...
				--local tcontinental = t_y - m2t_y
				--local mcontinental = m_y - p2m_y
				--local pcontinental = p_y - c2p_y
				----local ccontinental = c_y - (c_dist * v_mscale)
				----local bcontinental = (mcontinental + pcontinental + ccontinental)
				--local bcontinental = (tcontinental + mcontinental + pcontinental)
				--local bcontinental = (m2t_y + p2m_y + c2p_y)
