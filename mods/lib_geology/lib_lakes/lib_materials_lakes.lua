...
local c_mud_boil = minetest.get_content_id("gal:liquid_mud_boiling_source") 
local c_mud_wet = minetest.get_content_id("gal:mud_wet")
		...
		for divz=0,divs-1 do
			...
			for i=0,amount do
				...
				if ground_y and ground_y >= 2 then
					...
					if ground_name == "gal:liquid_water_source" then
						return
					end
