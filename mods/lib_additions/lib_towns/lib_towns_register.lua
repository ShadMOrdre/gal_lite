...
lib_towns.register_town("meserene_capital", {
	type = 2,				--defines role of city within state  (capital, hub, feeder, village)
	style = "Meserene",			--defines architectural style
	...
	buildings = {				--list of schematic definition names and other placement variables
		{name = "town_square",		mts = "bldg_town_square_x5_y9_z5_r000",				sub = "", hsize = 11, max_num = 0.000, rplc = "n", rot = "0", off = 0},
		{name = "fortress",		mts = "bldg_fortress_cornernote_x25_y22_z23_r000",		sub = "", hsize = 32, max_num = 0.010, rplc = "n", rot = "0", off = 0},
		{name = "church_nanuk",		mts = "bldg_church_nanuk_x22_y21_z13_r000",			sub = "", hsize = 26, max_num = 0.010, rplc = "n", rot = "180", off = 0},
		{name = "lumbermill_lv0",	mts = "bldg_sch_lumbermill_lv0_x12_y17_z22_r270",		sub = "", hsize = 26, max_num = 0.1, rplc = "n", rot = "90", off = -5},
		{name = "forge",		mts = "bldg_forge_x8_y6_z9_r270",				sub = "", hsize = 15, max_num = 0.1, rplc = "n", rot = "180", off = 1},
	...
	surface_mat = {				--defines the surface material node upon which town is placed
		...
		"gal:dirt_black_with_grass_cool_semihumid",
		"gal:dirt_brown_with_grass_cool_semihumid",
		"gal:dirt_clayey_with_grass_cool_semihumid",
		"gal:dirt_sandy_with_grass_cool_semihumid",
		"gal:dirt_silty_with_grass_cool_semihumid",
	},
	road_mat = {
		"gal:stone_cobble",
...
lib_towns.register_town("meserene_hub", {
	type = 2,				--defines role of city within state  (capital, hub, feeder, village)
	style = "Meserene",			--defines architectural style
	namegen = "mer_settlements",		--defines namegen set
	...
	buildings = {				--list of schematic definition names and other placement variables
		{name = "town_square",				mts = "bldg_town_square_x5_y9_z5_r000",				sub = "", hsize = 11,	max_num = 0.000, rplc = "n", rot = "0", off = 0},
		{name = "sanmiguel_de_lilo",			mts = "bldg_sanmiguel_de_lilo_x17_y17_z21_r090",		sub = "", hsize = 23,	max_num = 0.010, rplc = "n", rot = "270", off = 0},
		...
		{name = "forge",				mts = "bldg_forge_x8_y6_z9_r270",				sub = "", hsize = 15,	max_num = 0.1,   rplc = "n", rot = "180", off = 1},
		{name = "npc_house_l2",				mts = "bldg_sch_npc_house_l2_x18_y18_z23_r000",			sub = "", hsize = 27, max_num = 0.02, rplc = "n", rot = "0", off = 0},
...
lib_towns.register_town("meserene_feeder", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
...
lib_towns.register_town("imperial_capital", {
	...
	contents = {},				--list of building types that define industry and commerce for town
	buildings = {				--list of schematic definition names and other placement variables
		{name = "town_square",		mts = "bldg_town_square_x5_y9_z5_r000",						sub = "", hsize = 11, max_num = 0.000, rplc = "n", rot = "270", off = 0},
		{name = "church",		mts = "bldg_church_villages_x11_y16_z20_r180",					sub = "", hsize = 25, max_num = 0.010, rplc = "n", rot = "0", off = 0},
		{name = "castle1",		mts = "bldg_castle_imperial_x27_y16_z33_r90",					sub = "", hsize = 40, max_num = 0.010, rplc = "n", rot = "270", off = 0},
...
lib_towns.register_town("imperial_hub", {
	...
	buildings = {				--list of schematic definition names and other placement variables
		{name = "town_square",			mts = "bldg_town_square_x5_y9_z5_r000",				sub = "", hsize = 11, max_num = 0.000, rplc = "n", rot = "0", off = 0},
		{name = "church_npc_mg",		mts = "bldg_church_npc_x5_y14_z10_r000",			sub = "", hsize = 14, max_num = 0.000, rplc = "n", rot = "0", off = 0},
		{name = "townhall",			mts = "bldg_townhall_settlements_x10_y12_z11_r90",		sub = "", hsize = 15, max_num = 0.010, rplc = "n", rot = "270", off = 0},
		{name = "forge_npc_mg",			mts = "bldg_forge_npc_x10_y7_z8_r000",				sub = "", hsize = 14, max_num = 0.010, rplc = "n", rot = "0", off = 0},
		...
		{name = "house_01_npc_mg",		mts = "bldg_house_npc_01_x7_y7_z7_r000",			sub = "", hsize = 14, max_num = 0.035, rplc = "n", rot = "0", off = 0},
		{name = "house_02_npc_mg",		mts = "bldg_house_npc_02_x7_y7_z7_r000",			sub = "", hsize = 14, max_num = 0.035, rplc = "n", rot = "0", off = 0},
		{name = "mine_lv4",			mts = "bldg_mine_lv4_x11_y29_z9_r180",				sub = "", hsize = 15, max_num = 0.010, rplc = "n", rot = "0", off = 0},
		{name = "tower_01",			mts = "bldg_tower_01_x9_y16_z8_r180",				sub = "", hsize = 13, max_num = 0.025, rplc = "n", rot = "0", off = 0},
	},
	height_diff = 3,			--defines max height difference within block for town placement
...
lib_towns.register_town("cottages_village", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
	...
	buildings = {				--list of schematic definition names and other placement variables
		{name = "town_square",							mts = "bldg_town_square_x5_y9_z5_r000",					sub = "", hsize = 11, max_num = 0.000, rplc = "n", rot = "0", off = 0},
		{name = "schem_bldg_cottages_church_1_x26_y26_z12_r000",		mts = "schem_bldg_cottages_church_1_x26_y26_z12_r000",			sub = "", hsize = 30, max_num = 0.010, rplc = "n", rot = "0", off = 0},
...
lib_towns.register_town("gambit_village", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
...
lib_towns.register_town("lumberjack_village", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
...
lib_towns.register_town("desert_sand_city", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
	...
	buildings = {				--list of schematic definition names and other placement variables
		...
		{name = "earthbuild_3story",		mts = "bldg_sch_earthbuild_3story_x13_y20_z13_r000",			sub = "", hsize = 17, max_num = 0.000, rplc = "n", rot = "0", off = 0},
...
lib_towns.register_town("desert_temple", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
	style = "Egyptian",			--defines architectural style
	namegen = "desert_settlement",		--defines namegen set
	max_size = 5,				--maximum size of town
	min_size = 3,				--minimum size of town
	layout = 1,
	grid_size = 8,
	contents = {},				--list of building types that define industry and commerce for town
	buildings = {				--list of schematic definition names and other placement variables
		--{name = "mgs_temple_large_02_21w_19l_32h_0_180", mts = lib_towns.schematics["mgs_temple_large_02_21w_19l_32h_0_180"],			hsize = 22, max_num = 0.050, rplc = "n", rot = "-1", off = 0},
		{name = "schem_sandcity_anubis_statue", mts = "schem_sandcity_anubis_statue_x11_y17_z5_r000",			sub = "", hsize = 15, max_num = 0.000, rplc = "n", rot = "-1", off = 0},
		{name = "pyramid",			mts = "bldg_sch_pyramid_x21_y12_z21_r180",				sub = "", hsize = 24, max_num = 0.020, rplc = "n", rot = "180", off = 0},
...
lib_towns.register_town("desert_stone_city", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
	style = "Desert",			--defines architectural style
	namegen = "desert_settlement",		--defines namegen set
	max_size = 120,				--maximum size of town
...
lib_towns.register_town("grasshut_village", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
	...
	contents = {},				--list of building types that define industry and commerce for town
	buildings = {				--list of schematic definition names and other placement variables
		{name = "earthbuild_roundhouse",	mts = "bldg_sch_earthbuild_roundhouse_x17_y18_z17_r000",		sub = "", hsize = 21, max_num = 0.00, rplc = "n", rot = "0", off = -1},
		{name = "grass_well",			mts = "schem_grass_well_x5_y14_z5_r090",				sub = "", hsize = 10, max_num = 0.050, rplc = "n", rot = "0", off = -6},
		{name = "grass_shop",			mts = "schem_grass_shop_x9_y12_z9_r090",				sub = "", hsize = 13, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_inn",			mts = "schem_grass_inn_x9_y12_z9_r090",					sub = "", hsize = 13, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_pub",			mts = "schem_grass_pub_x9_y11_z9_r090",					sub = "", hsize = 13, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_hut1",			mts = "schem_grass_hut1_x6_y7_z6_r090",					sub = "", hsize = 10, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_hut2",			mts = "schem_grass_hut2_x9_y11_z9_r090",				sub = "", hsize = 13, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_hut3",			mts = "schem_grass_hut3_x7_y8_z7_r090",					sub = "", hsize = 10, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_hut4",			mts = "schem_grass_hut4_x7_y8_z7_r090",					sub = "", hsize = 10, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_hut5",			mts = "schem_grass_hut5_x5_y7_z5_r090",					sub = "", hsize = 10, max_num = 0.050, rplc = "n", rot = "0", off = 0},
		{name = "grass_hut7",			mts = "schem_grass_hut7_x6_y7_z6_r090",					sub = "", hsize = 10, max_num = 0.050, rplc = "n", rot = "0", off = 0},
...
lib_towns.register_town("jungle_temple", {
	type = 2	,			--defines role of city within state  (capital, hub, feeder, village)
	style = "Grasshut",			--defines architectural style
	namegen = "jungle_camps",		--defines namegen set
	max_size = 120,				--maximum size of town
...
lib_towns.register_town("dev", {
	...
	buildings = {				--list of schematic definition names and other placement variables
		...
		{name = "fort_dm",			mts = "bldg_sch_fort_dm_x29_y13_z31_r000",			sub = "", hsize = 35, max_num = 0, rplc = "n", rot = "0", off = 0},
		{name = "fort_desert",			mts = "bldg_sch_fort_desert_x43_y27_z43_r000",			sub = "", hsize = 47, max_num = 0.05, rplc = "n", rot = "0", off = 0},
		{name = "fort_gondor",			mts = "bldg_fort_gondor_x15_y30_z16_r000",			sub = "", hsize = 35, max_num = 0, rplc = "n", rot = "0", off = 0},
		{name = "fort_orc",			mts = "bldg_sch_fort_orc_x_y_z_r000",				sub = "", hsize = 35, max_num = 0, rplc = "n", rot = "0", off = 0},
		{name = "fort_rohan",			mts = "bldg_fort_rohan_x21_y23_z21_r000",			sub = "", hsize = 35, max_num = 0, rplc = "n", rot = "0", off = 0},
