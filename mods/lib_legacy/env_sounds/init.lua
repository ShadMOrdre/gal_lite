...
local allsounds = {
	["env_sounds_water"] = {
		trigger = {"gal:liquid_water_flowing", "gal:liquid_water_river_flowing"},
		base_volume = 0.04,
		max_volume = 0.4,
		per_node = 0.004,
	},
	["env_sounds_lava"] = {
		trigger = {"gal:liquid_lava_source", "gal:liquid_lava_flowing"},
		base_volume = 0,
		max_volume = 0.6,
		per_node = {
			["gal:liquid_lava_source"] = 0.008,
			["gal:liquid_lava_flowing"] = 0.002,
		},
	},
}
