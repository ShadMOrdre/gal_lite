...
-- Coral reefs
	...
	minetest.register_decoration({
		...
		y_min = -14,
		flags = "force_placement",
		schematic = gal_ecology_trees.schem("coral_brain_pink")
	})
	...
	minetest.register_decoration({
		...
		y_min = -14,
		flags = "force_placement",
		schematic = gal_ecology_trees.schem("coral_bubble")
	})
	...
	minetest.register_decoration({
		...
		y_min = -14,
		flags = "force_placement",
		schematic = gal_ecology_trees.schem("coral_fire")
	})
	...
	minetest.register_decoration({
		...
		y_min = -14,
		flags = "force_placement",
		schematic = gal_ecology_trees.schem("coral_pillar")
	})
...
--		},
	...
	minetest.register_decoration({
		...
		y_min = heights["beach_depth"] - gal_ecology_trees.biome_vertical_blend,
		y_max = heights["beach"] + gal_ecology_trees.biome_vertical_blend,
		schematic = gal_ecology_trees.schem("plant_reedmace_01", ""),
	...
	minetest.register_decoration({
		...
		y_min = heights["beach_depth"] - gal_ecology_trees.biome_vertical_blend,
		y_max = heights["beach"] + gal_ecology_trees.biome_vertical_blend,
		schematic = gal_ecology_trees.schem("plant_reedmace_02", ""),
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
	})
